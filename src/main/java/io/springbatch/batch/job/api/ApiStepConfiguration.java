...
import io.springbatch.batch.chunk.processor.ApiItemProcessor1;
import io.springbatch.batch.chunk.processor.ApiItemProcessor2;
import io.springbatch.batch.chunk.processor.ApiItemProcessor3;
import io.springbatch.batch.chunk.writer.ApiItemWriter1;
import io.springbatch.batch.chunk.writer.ApiItemWriter2;
import io.springbatch.batch.chunk.writer.ApiItemWriter3;
import io.springbatch.batch.classifier.ProcessorClassifier;
import io.springbatch.batch.classifier.WriterClassifier;
import io.springbatch.batch.domain.ApiRequestVO;
import io.springbatch.batch.domain.ProductVO;
import io.springbatch.batch.partition.ProductPartitioner;
...
public class ApiStepConfiguration {
    ...
    @Bean
    public Step apiMasterStep(JobRepository jobRepository, @Qualifier("apiSlaveStep") Step apiSlaveStep) {

package io.springbatch.batch.job.file;

import io.springbatch.batch.chunk.processor.FileItemProcessor;
...
public class FileJobConfiguration {
    ...
    @Bean
    public Job fileJob(JobRepository jobRepository, @Qualifier("fileStep") Step step) {
